...
const usersProductsDB = {
  getProductAll(email) {
    const sql =
      "SELECT * FROM users JOIN PRODUCTS ON users.user_id = products.user_id;";
  ...
  addNewProduct(
    ...
    const sql =
      "INSERT INTO products(name, description, address, availability, imageurl, category, price, user_id) VALUES($1, $2, $3, $4, $5, $6, $7, $8)";
    const values = [
      name,
      description,
      address,
  ...
  addReview(review, rating, date, authorID, productID) {
    const sql =
      "INSERT INTO reviews (review , rating, date, authorid , productid) VALUES ($1 , $2 , $3, $4, $5);";
