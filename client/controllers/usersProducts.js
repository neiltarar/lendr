...
usersProductsController.post("/host", sessionAuth, (req, res) => {
  //add product
  const { name, description, address, availability, image, category, price } =
    req.body;
  console.log(req.body);
...
usersProductsController.patch("/:id", sessionAuth, (req, res) => {
  //update product all parameters
  const { name, description, address, availability, image, category, price } =
    req.body;
  console.log(req.body);
